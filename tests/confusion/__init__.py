...
def test_create_from_segments():
    segments = [
        alignment.Segment(0, 4, assets.Label('music', start=0, end=5), assets.Label('music', start=0, end=4)),
        alignment.Segment(4, 5, assets.Label('music', start=0, end=5), assets.Label('speech', start=4, end=6)),
        alignment.Segment(5, 6, assets.Label('speech', start=5, end=11), assets.Label('speech', start=4, end=6)),
        alignment.Segment(6, 8, assets.Label('speech', start=5, end=11), None),
        alignment.Segment(8, 11, assets.Label('speech', start=5, end=11), assets.Label('mix', start=8, end=16)),
        alignment.Segment(11, 14, assets.Label('mix', start=11, end=14), assets.Label('mix', start=8, end=16)),
        alignment.Segment(14, 16, assets.Label('speech', start=14, end=19), assets.Label('mix', start=8, end=16)),
        alignment.Segment(16, 19, assets.Label('speech', start=14, end=19), assets.Label('speech', start=16, end=21)),
        alignment.Segment(19, 21, None, assets.Label('speech', start=16, end=21))
    ]
