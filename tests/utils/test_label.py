...
def test_overlap_time_with_full_overlap_ref():
    overlap = label.overlap_time(assets.Label('a', start=2.5, end=4.3),
                                 assets.Label('b', start=2.49, end=4.92))
    assert overlap == pytest.approx(4.3 - 2.5)


def test_overlap_time_with_full_overlap_hyp():
    overlap = label.overlap_time(assets.Label('a', start=1.45, end=5.33),
                                 assets.Label('b', start=2.49, end=4.92))
...
def test_overlap_time_with_right_overlap():
    overlap = label.overlap_time(assets.Label('a', start=1.45, end=2.23),
                                 assets.Label('b', start=2.11, end=4.92))
