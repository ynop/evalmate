...
class SegmentAligner(object):
    """
    Compute an alignment on segment level. It returns a list of segments.
    ...
    def align(self, ll_ref, ll_hyp):
        ...
        refs = SegmentAligner.set_absolute_end_of_labels(ll_ref)
        hyps = SegmentAligner.set_absolute_end_of_labels(ll_hyp)

        events = SegmentAligner.create_event_list(refs, hyps, time_threshold=0.01)
        ...
        for index, event in enumerate(events):
            ...
            if index == 0:
                ...
                new_segment = structure.Segment(current_start, time)
